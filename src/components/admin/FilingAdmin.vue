    ...
    <div class="filingMainContent">
        <div class="tableContent">
            <el-table :data="data" border class="table" max-height="100vh - 100px">
                <el-table-column align="center" header-align="center" label="分类ID" prop="filingName.id" sortable/>
                <el-table-column align="center" header-align="center" label="分类名称" prop="filingName.filingName"
                                 sortable/>
                <el-table-column align="center" header-align="center" label="子文件个数" prop="count" sortable/>
                <el-table-column>
                    <template #header>
                        <div class="addForm">
                            <el-input v-model="addForm.filingName" placeholder="输入分类名" size="small"/>
                            <el-button size="small" @click="addFiling">ADD NEW</el-button>
                        </div>
                    </template>
        ...
        <el-dialog
            ...
            <template #footer>
                <span class="dialog-footer">
                    ...
                    <el-button type="primary" @click="dialog.edit = false;submitEdit()">确定</el-button>
                </span>
            </template>
        </el-dialog>
        <el-dialog
