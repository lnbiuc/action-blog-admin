    ...
    <div class="tagMainContent">
        <div class="tableContent">
            ...
            <el-table :data="data" border class="table" max-height="100vh - 100px">
                <el-table-column align="center" header-align="center" label="标签ID" prop="tagId" sortable/>
                <el-table-column align="center" header-align="center" label="标签名称" prop="tagName" sortable/>
                <el-table-column align="center" header-align="center" label="引用次数" prop="count" sortable/>
                <el-table-column>
                    <template #header>
                        <div class="addForm">
                            <el-input v-model="addForm.tagName" placeholder="输入标签名" size="small"/>
                            <el-button size="small" @click="addNewTag">ADD NEW</el-button>
                        </div>
                    </template>
