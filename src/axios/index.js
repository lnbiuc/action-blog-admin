...
export function deleteAnnoById(id) {
	let formData = new FormData();
	formData.append('id', id);
	return axios({
		url: './admin/anno/delete',
		method: 'POST',
		data: formData,
	});
}

export function publishAnno(content) {
	let formData = new FormData();
	formData.append('content', content);
	return axios({
		url: './admin/anno/publish',
		method: 'POST',
		data: formData,
	});
}

export function publishAnnoTime(content, timeStr) {
	let formData = new FormData();
	formData.append('content', content);
	formData.append('time', timeStr);
	return axios({
		url: './admin/anno/publishTime',
		method: 'POST',
		data: formData,
	});
}
...
export function sendAboutMeInfo(violet) {
	let formData = new FormData();
	formData.append('violet', violet);
	return axios({
		url: './admin/me/edit',
		method: 'POST',
		data: formData,
...
export function addFriend(title, dex, index, avatar) {
	return axios({
...
export function editFriends(id, title, dex, index, avatar, status) {
	return axios({
